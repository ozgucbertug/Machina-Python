    ...
    def motionMode(self,mode):
        ...
        if self.debug:
            if not isinstance(mode, str):
                raise ValueError("motionType {}".format(self.stringError))  
    ...
    def move(self, xInc, yInc, zInc = 0):
        if self.debug:
            if not isinstance(xInc, float):
                raise ValueError("xInc {}".format(self.floatError))
            if not isinstance(yInc, float):
                raise ValueError("yInc {}".format(self.floatError))
            if not isinstance(zInc, float):
                raise ValueError("zInc {}".format(self.floatError))
    ...
    def moveTo (self,x,y,z):
        if self.debug:
            if not isinstance(x, float):
                raise ValueError("x {}".format(self.floatError))
            if not isinstance(y, float):
                raise ValueError("y {}".format(self.floatError))
            if not isinstance(z, float):
                raise ValueError("z {}".format(self.floatError))
    ...
    def externalAxis(self,axisNumber,increment):
        if self.debug:
            if not isinstance(axisNumber, int):
                raise ValueError("axisNumber {}".format(self.intError))

            if 1> axisNumber or axisNumber >6 :
                raise ValueError("axisNumber {}".format(self.externalAxisError))

            if not isinstance(increment, float):
                raise ValueError("increment {}".format(self.floatError))
    ...
    def externalAxisTo(self,axisNumber, val):
        if self.debug:
            ...
            if not isinstance(val, float):
                raise ValueError("val {}".format(self.floatError))
